export const TRACK_NAME = "marblesoda";
...
// *** COLORS ***
export const CURSOR_COLOR: [number, number, number] = [173, 255, 47];
export const SLICE_COLOR: [number, number, number] = [51, 51, 51];
export const NOTE_COLOR: [number, number, number] = [255, 255, 255]; // originally 255, 0, 0
export const NOTE_GLOW = "rgb(190, 183, 223)";
